...
function generateCanvasContent() {
  ...
  generateButton.addEventListener("click", function () {
    ...
    document
      ...
      .addEventListener("input", updateStyles);
    document
      .getElementById("fontSize-selector")
      .addEventListener("input", updateStyles);
    document
      .getElementById("font-selector")
      .addEventListener("change", updateStyles);

    // Example function to update styles
    function updateStyles() {
      ...
      if (generatedTextElement) {
        generatedTextElement.style.color = textColor;
        generatedTextElement.style.backgroundColor = backgroundColor;
        generatedTextElement.style.fontSize = `${fontSize}px`;
        generatedTextElement.style.fontFamily = font;
      }
    }
    /// ===
